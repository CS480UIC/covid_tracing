...
public class Entity1Service {
	 ...
	 */
	public void create(Employee form) throws Entity1Exception, ClassNotFoundException, InstantiationException, IllegalAccessException{
		// check the primary key of Entity1
		Employee entity1 = entity1Dao.findByUsername(form.getUsername());
	 ...
	 * @throws InstantiationException 
	 */
	public void login(Employee form) throws Entity1Exception, ClassNotFoundException, InstantiationException, IllegalAccessException {
		Employee user = entity1Dao.findByUsername(form.getUsername());
